  ...
  export const WelcomeHouseRules = defineDocumentType(() => ({
  ...
  export const UserInstructions = defineDocumentType(() => ({
  ...
  export const CriticalInfo = defineDocumentType(() => ({
    name: 'CriticalInfo',
  ...
  export const LocalGuide = defineDocumentType(() => ({
    name: 'LocalGuide',
